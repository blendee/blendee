 ...
 */
public abstract class AbstractGroupByQueryColumn<T> extends AbstractQueryColumn<T> implements SelectOffer {
	 ...
	 * @param name カラム名
	 */
	public AbstractGroupByQueryColumn(QueryRelationship helper, String name) {
		super(helper, name);
	}
