...
class Subquery {
	 ...
	 */
	static Criteria createCriteria(QueryBuilder builder, boolean notIn, Query mainquery) {
	 ...
	 * @return {@link Criteria} となったサブクエリ
	 */
	static Criteria createCriteria(QueryBuilder builder, boolean notIn, Column... mainQueryColumn) {
		return CriteriaFactory
			//SQLDecoratorでサブクエリのSELECT句自体が変更されている場合を考慮し、SELECT句チェックを行わない
			.createSubqueryWithoutCheck(
				mainQueryColumn,
